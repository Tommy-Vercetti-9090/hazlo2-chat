...
import socialAuthConfig from "../Config/socialAuthConfig.js";

config();
export const accessTokenValidator = async (accessToken, socialType) => {
  const { FACEBOOK_APP_ID, FACEBOOK_APP_SECRET, GOOGLE_CLIENT_ID } =
    socialAuthConfig;
  ...
  switch (socialType) {
    case "facebook": {
      ...
      console.log({ facebookSocialAuthObj: getUserData });
